...
import net.mcreator.moddymcmodface.block.NoticeBoardBlock.CustomTileEntity;
...
public class NoticeBoardGuiGui extends ModdymcmodfaceModElements.ModElement {
	...
	public NoticeBoardGuiGui(ModdymcmodfaceModElements instance) {
		super(instance, 85);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("notice_board_gui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("moddymcmodface:textures/notice_board_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("NoticeBoard", 16, 11, -16777216);
		}*/
		@Override
